...
public class AssetSetter {
    ...
    public void setLightUnits() {
        gp.LightUnits.add(new Prince(gp, keyH, "Alm", Entity.UnitRace.Human, 30, 14));
 //       gp.LightUnits.add(new Sage(gp, keyH, "Boey", Entity.UnitRace.Elf, 31, 15));
        gp.LightUnits.add(new Cleric(gp, keyH, "Shade", Entity.UnitRace.Elf, 31, 14));
//        gp.LightUnits.add(new DarkMage(gp, keyH, "Iago", Entity.UnitRace.Orc, 29, 15));
//        gp.LightUnits.add(new Knight(gp, keyH, "Rudolf", Entity.UnitRace.Elf, 28, 14));
        gp.LightUnits.add(new Knight(gp, keyH, "Berkut", Entity.UnitRace.Orc, 28, 12));
//        gp.LightUnits.add(new Mage(gp, keyH, "Robin", Entity.UnitRace.Human, 27, 15));
